    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <header className="sticky top-0 z-30 border-b border-slate-200/70 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-base font-semibold tracking-tight sm:text-lg">OptiFlow AI</div>
              <div className="text-[11px] text-slate-500 sm:text-xs">AI automation bureau</div>
            </div>
          </div>
      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 sm:py-16 lg:grid-cols-2 lg:gap-14 lg:px-8 lg:py-28">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
                <a
                  href="#contact"
                  className="rounded-2xl bg-slate-900 px-6 py-3 text-center text-sm font-medium text-white shadow-lg shadow-slate-900/10 transition hover:-translate-y-0.5"
                >
                  Plan een strategiegesprek
                </a>
                <a
                  href="#results"
                  className="rounded-2xl border border-slate-300 bg-white px-6 py-3 text-center text-sm font-medium text-slate-700 transition hover:border-slate-400"
                >
                  Bekijk toepassingen
                </a>
              </div>

              <div className="mt-10 grid grid-cols-2 gap-5 text-sm text-slate-500 sm:flex sm:flex-wrap sm:items-center sm:gap-8">
                <div>
            ...
            <div className="relative">
              <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-2xl shadow-slate-200/60 sm:rounded-[28px] sm:p-5">
                <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-4 sm:rounded-[22px] sm:p-5">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div
                        key={title}
                        className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-3 sm:gap-4 sm:p-4"
                      >
        ...
        <section className="border-y border-slate-200 bg-white">
          <div className="mx-auto grid max-w-7xl gap-6 px-4 py-6 text-center text-sm text-slate-500 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
        ...
        <section id="solutions" className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="max-w-2xl">
          ...
          <div className="mt-10 grid gap-4 sm:gap-6 md:grid-cols-2 xl:grid-cols-4">
            {[
              ...
              <div key={item.title} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
            ...
            <div className="mt-10 grid gap-4 sm:gap-6 lg:grid-cols-3">
              {[
                ...
                <div key={item.metric} className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur sm:p-8">
        ...
        <section id="process" className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="space-y-4 sm:space-y-5">
              {[
                ...
                <div key={num} className="flex gap-4 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:gap-5 sm:p-6">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 sm:pb-16 lg:px-8 lg:pb-20">
          <div className="rounded-[32px] border border-slate-200 bg-gradient-to-r from-blue-500 to-lime-400 p-[1px] shadow-xl shadow-slate-200/50">
            <div className="rounded-[31px] bg-white px-5 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-14">
              <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center rounded-2xl bg-slate-900 px-6 py-3 text-center text-sm font-medium text-white transition hover:-translate-y-0.5"
                >
                  Plan je analyse
                </a>
              </div>
        ...
        <section id="faq" className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 sm:pb-16 lg:px-8 lg:pb-20">
          <div className="max-w-2xl">
          ...
          <div className="mt-8 grid gap-4 sm:mt-10">
            {[
              [
                "Met wat voor bedrijven werken jullie?",
                "We ondersteunen vooral dienstverleners, bureaus, consultants en kleine teams die handmatig werk willen verminderen en sneller willen werken.",
              ],
              [
                "Hoe snel kunnen we live?",
                "De meeste eerste workflows kunnen binnen 2 tot 4 weken worden uitgewerkt en live gezet, afhankelijk van complexiteit en integraties.",
              ],
              [
                "Vervangen jullie onze huidige tools?",
                "Meestal niet. We koppelen en optimaliseren de tools die je al gebruikt en voegen AI toe waar het echt meerwaarde oplevert.",
              ],
            ].map(([q, a]) => (
              <div key={q} className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        ...
        <section id="contact" className="border-t border-slate-200 bg-white">
          <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 sm:py-16 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-20">
            <div>
            ...
            <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-5 shadow-sm sm:rounded-[28px] sm:p-6">
              <div className="grid gap-4 sm:grid-cols-2">
                <input
                  className="rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none ring-0 placeholder:text-slate-400"
              ...
              <input
                className="mt-4 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none placeholder:text-slate-400"
              ...
              />
              <textarea
                className="mt-4 min-h-[120px] w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 outline-none placeholder:text-slate-400 sm:min-h-[140px]"
                placeholder="Welke workflow wil je automatiseren?"
              />
